...
/datum/round_event/meteor_wave/announce(fake)
	priority_announce("our evil counter investors have sent a billion million meteors to your location, buy from cargo the shields please", "APIOIDS Secret Service", ANNOUNCER_METEORS)
