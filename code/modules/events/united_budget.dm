...
/datum/round_event/united_budget_setup/announce()
	priority_announce("OUR BUDGET", "United States of Galentopia", SSstation.announcer.get_rand_alert_sound())
...
/datum/round_event/united_budget_cancel/announce()
	priority_announce("weehhh", "United States of Galentopia", SSstation.announcer.get_rand_alert_sound())
