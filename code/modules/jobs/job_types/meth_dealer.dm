/datum/job/meth_dealer
	title = JOB_NAME_METH_DEALER
	description = "Meth."
	department_for_prefs = DEPT_NAME_MEDICAL
	department_head = list(JOB_NAME_CHIEFMEDICALOFFICER)
	supervisors = "Walter white."
	faction = "Station"
	total_positions = 2
	spawn_positions = 2
	...
	display_order = JOB_DISPLAY_ORDER_METH_DEALER
	rpg_title = "Whaltest of Whites"
